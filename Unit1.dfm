object Form1: TForm1
  ...
  object enlang: TsMemo
    ...
    Text = 
      ...
      ' Status: Something went wrong :('#13#10'Load'#13#10
  end
  object rulang: TsMemo
    ...
    Text = 
      ...
      #1076#1082#1083#1102#1095#1077#1085#1080#1103': '#1063#1090#1086'-'#1090#1086' '#1087#1086#1096#1083#1086' '#1085#1077' '#1090#1072#1082' :('#13#10#1047#1072#1075#1088#1091#1079#1080#1090#1100#13#10
  end
