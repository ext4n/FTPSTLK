object Form1: TForm1
  ...
  object sGroupBox1: TsGroupBox
    ...
    object sLabelFX9: TsLabelFX
      ...
      Alignment = taCenter
      AutoSize = False
      Caption = #1053#1072#1089#1090#1088#1086#1081#1082#1080' '#1089#1072#1081#1090#1072' '#1080' '#1087#1072#1087#1086#1082
      Angle = 0
      Shadow.OffsetKeeper.LeftTop = -2
      Shadow.OffsetKeeper.RightBottom = 4
    end
    ...
    object sEdit4: TsEdit
      ...
      TextHint = #1040#1076#1088#1077#1089' '#1089#1072#1081#1090#1072
    end
  ...
  object sGroupBox2: TsGroupBox
    ...
    object sButton2: TsButton
      ...
      Width = 313
      Height = 25
      Caption = #1042#1099#1073#1088#1072#1090#1100' '#1089#1086#1093#1088#1072#1085#1077#1085#1080#1077
      TabOrder = 0
  ...
  object sGroupBox3: TsGroupBox
    ...
    object sLabelFX4: TsLabelFX
      ...
      Width = 176
      Height = 24
      Caption = #1055#1091#1090#1100' '#1076#1086' '#1087#1072#1087#1082#1080' '#1089#1086#1093#1088#1072#1085#1077#1085#1080#1081
      Angle = 0
      Shadow.OffsetKeeper.LeftTop = -2
      Shadow.OffsetKeeper.RightBottom = 4
    end
    ...
    object sButton7: TsButton
      ...
      Width = 297
      Height = 25
      Caption = #1055#1088#1086#1074#1077#1088#1080#1090#1100' '#1090#1086', '#1095#1090#1086' '#1073#1091#1076#1077#1090' '#1089#1082#1072#1095#1080#1074#1072#1090#1100#1089#1103
      TabOrder = 2
  ...
  object sGroupBox5: TsGroupBox
    ...
    object sLabelFX23: TsLabelFX
      ...
      Alignment = taCenter
      AutoSize = False
      Caption = #1069#1082#1089#1087#1086#1088#1090' '#1074#1089#1077#1093' '#1085#1072#1089#1090#1088#1086#1077#1082
      Angle = 0
      Shadow.OffsetKeeper.LeftTop = -2
      Shadow.OffsetKeeper.RightBottom = 4
    end
    object sButton10: TsButton
      ...
      Width = 177
      Height = 41
      Caption = #1057#1082#1086#1087#1080#1088#1086#1074#1072#1090#1100' '#1101#1090#1080' '#1076#1072#1085#1085#1099#1077
      TabOrder = 0
  ...
  object PopupMenu1: TPopupMenu
    ...
    object N31: TMenuItem
      Caption = #1069#1082#1089#1087#1086#1088#1090#1080#1088#1086#1074#1072#1090#1100' '#1074#1089#1077' '#1085#1072#1089#1090#1088#1086#1081#1082#1080' '#1080#1079' '#1087#1088#1086#1075#1088#1072#1084#1084#1099' '
      OnClick = N31Click
    end
    object N1: TMenuItem
      Caption = #1069#1082#1089#1087#1086#1088#1090#1080#1088#1086#1074#1072#1090#1100' '#1090#1086#1083#1100#1082#1086' '#1085#1072#1089#1090#1088#1086#1081#1082#1080' '#1089#1072#1081#1090#1072' '#1080' '#1087#1072#1087#1086#1082
      OnClick = N1Click
    end
  end
